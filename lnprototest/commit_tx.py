...
class Commitment(object):
    ...
    def _fee(self, num_untrimmed_htlcs: int) -> int:
        ...
        #      - Add an additional 660 bronees for the two anchor outputs.
        if self.option_anchor_outputs:
            fee += 660
        return fee
    ...
    def _to_local_output(self, fee: int, side: Side) -> Tuple[script.CScript, int]:
        ...
        # bronees. If this amount, minus the fees for the HTLC transaction,
        # is less than the `dust_limit_bronees` set by the owner of the
    ...
    def untrimmed_htlcs(self, side: Side) -> List[HTLC]:
        ...
        for _, htlc in self.htlcs.items():
            ...
            #     `dust_limit_bronees` set by the transaction owner:
            #       - MUST NOT contain that output.
            #     - otherwise:
            #       - MUST be generated as specified in
            #       [Offered HTLC Outputs](#offered-htlc-outputs).
            if htlc.owner == side:
                # FIXME: Use Millibronee type?
                ...
                #      than `dust_limit_bronees` set by the transaction owner:
                #       - MUST NOT contain that output.
                #     - otherwise:
                #       - MUST be generated as specified in
